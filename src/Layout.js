...
function Layout() {
  ...
  const saveNote = async (note, index) => {
    ...
    //----------------need to work here----------------
    await fetch(
      "https://itusmthbdfug33czd22rthkc4a0ygmqu.lambda-url.ca-central-1.on.aws/",
      //----------------need to work here----------------
  ...
  const deleteNote = async (index, user) => {
    ...
    //----------------need to work here----------------
    await fetch(
      "https://63d3jwdkqnhma6iqsconulwjby0ijirm.lambda-url.ca-central-1.on.aws/",
      //----------------need to work here----------------
  ...
  const getNotes = async (profile, aToken) => {
    ...
    const res = await fetch(
      `https://7rfyhwg2ov64bg6bm3oxz5frz40ktosx.lambda-url.ca-central-1.on.aws?email=${email}`,
      //----------------need to work here----------------
