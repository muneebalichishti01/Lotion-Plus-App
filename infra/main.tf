...
provider "aws" {
  region = "ca-central-1"
  access_key = "AKIAXNI2EV4R5KXSJTYO"
  secret_key = "ZGW23LKllkey5HLZ74T+v9RWCDXNqO3YAjC0hd6J"
}

# the locals block is used to declare constants that 
# you can use throughout your code
locals {
  save_name   = "save-note-30147888"
  get_name    = "get-notes-30147888"
  delete_name = "delete-note-30147888"
  ...
  "Statement": [
    {
      ...
      "Resource":["arn:aws:dynamodb:::table/","arn:aws:logs:::","arn:aws:dynamodb:ca-central-1:509545328419:table/lotion-30142452"],
      "Effect": "Allow"
    }
  ]
}
...
# Dynamo table
resource "aws_dynamodb_table" "lotion-30142452" {
  name           = "lotion-30142452"
  hash_key       = "email"
  range_key      = "id"
